...
class PositronAngleModel(GraphModel):
    """Graph-level regressor outputting two angle components per graph."""
    ...
    def forward(self, data: Data) -> torch.Tensor:
        """Forward pass returning two angle components per graph."""
