...
class EndpointRegressorServiceBase(BasePipelineService):
    def __init__(
        self,
        *,
        ...
        if not isinstance(factory, EndpointRegressorGraphLoaderFactory):
            raise RuntimeError("Dataset is missing EndpointRegressorGraphLoaderFactory.")
