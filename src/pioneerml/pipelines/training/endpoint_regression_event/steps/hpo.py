...
from pioneerml.pipelines.training.endpoint_regression_event.steps.train import (
...
@step
def tune_endpoint_regressor_event(
    ...
    defaults = {
        ...
        "direction": "minimize",
        "seed": None,
        "study_name": "endpoints_regressor_event_hpo",
        "storage": None,
        "fallback_dir": None,
    ...
    if "output_dim" not in base_model_cfg:
        base_model_cfg["output_dim"] = int(dataset.targets.shape[-1])
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        model = EndpointsRegressorEvent(
            ...
            output_dim=int(base_model_cfg["output_dim"]),
        )
    ...
    study, storage_used = _optimize(
        ...
        study_name=str(cfg.get("study_name", "endpoints_regressor_event_hpo")),
