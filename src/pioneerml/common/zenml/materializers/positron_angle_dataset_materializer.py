...
try:
    ...
    PositronAngleDataset = None


class PositronAngleDatasetMaterializer(BaseMaterializer):
    """Materializer for PositronAngleDataset artifacts."""

    SKIP_REGISTRATION = False
    ASSOCIATED_TYPES = (PositronAngleDataset,) if PositronAngleDataset is not None else ()
