...
class GroupSplitterObjectiveAdapter(BaseObjectiveAdapter):
    ...
    def suggest_model_params(self, *, trial: optuna.Trial, model_search_cfg: dict | None = None) -> dict:
        ...
        return {
            "in_channels": int(GroupSplitterGraphLoader.NODE_FEATURE_DIM),
            "prob_dimension": int(GroupSplitterGraphLoader.NUM_CLASSES),
            "hidden": int(hidden),
            "heads": int(heads),
    ...
    def default_model_cfg(self, model_cfg: dict | None = None) -> dict:
        ...
        cfg.setdefault("in_channels", int(GroupSplitterGraphLoader.NODE_FEATURE_DIM))
        cfg.setdefault("prob_dimension", int(GroupSplitterGraphLoader.NUM_CLASSES))
    ...
    def build_model(self, *, model_cfg: dict, compile_cfg: dict | None, context: str):
        ...
        return GroupSplitter(
            ...
            prob_dimension=int(cfg["prob_dimension"]),
            hidden=hidden,
            heads=heads,
