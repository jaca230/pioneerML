...
class PositronAngleInferenceServiceBase(BasePipelineService):
    QUANTILE_SUFFIXES = ("q16", "q50", "q84")
    TARGET_AXES = ("px", "py", "pz")
    ...
    @staticmethod
    def resolve_inference_runtime(config_json: dict) -> tuple[str, bool, bool, bool, bool, bool, int, int, int]:
        ...
        use_pion_stop_preds = bool(config_json.get("use_pion_stop_preds", True))
    ...
    def build_prediction_table(
        ...
        *,
        ...
        if pred_dim not in (3, 9):
            raise ValueError(f"Unsupported positron prediction dimension {pred_dim}. Expected 3 or 9.")
