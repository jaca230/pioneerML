...
from pioneerml.common.loader.array_store import NDArrayStore
from pioneerml.common.loader.stage.stages import NodeFeatureStage
...
class EndpointNodeFeatureStage(NodeFeatureStage):
    ...
    def run(self, *, state: MutableMapping[str, Any], loader) -> None:
        ...
        if total_nodes > 0:
            ...
            elif bool(getattr(loader, "include_targets", False)) and chunk_in.has_raw(chunk_in.values_key(self.particle_mask_field)):
