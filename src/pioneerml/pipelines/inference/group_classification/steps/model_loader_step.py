...
class GroupClassifierInferenceModelLoaderStep(BaseModelLoaderStep):
...
def load_group_classifier_model_step(
    ...
    return GroupClassifierInferenceModelLoaderStep(pipeline_config=pipeline_config).execute(model_path=model_path)
