...
from pioneerml.pipelines.training.group_splitting_event.steps.train import (
...
def tune_group_splitter_event(
    ...
    defaults = {
        ...
        "direction": "minimize",
        "seed": None,
        "study_name": "group_splitter_event_hpo",
        "storage": None,
        "fallback_dir": None,
    ...
    study, storage_used = _optimize(
        ...
        study_name=str(cfg.get("study_name", "group_splitter_event_hpo")),
