"""
Loader for PositronAngleModel models.
"""
...
from pioneerml.models.regressors import PositronAngleModel
from .base import ModelLoader
from .registry import register_model_loader


@register_model_loader("PositronAngleModel")
class PositronAngleModelLoader(ModelLoader):
    """Loader for PositronAngleModel models."""
    ...
    def load_model(
        ...
        *,
        ...
        """Load a PositronAngleModel from metadata."""
        defaults = {
            "hidden": 128,
            "heads": 4,
            "layers": 2,
