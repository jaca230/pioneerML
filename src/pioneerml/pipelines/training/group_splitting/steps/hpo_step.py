...
class GroupSplitterHPOStep(BaseHPOStep):
    step_key = "hpo"
    ...
    def objective_context(self) -> str:
        return "tune_group_splitter"

    def study_name_default(self) -> str:
        return "group_splitter_hpo"
...
def tune_group_splitter_step(
    ...
    return GroupSplitterHPOStep(dataset=dataset, pipeline_config=pipeline_config).execute()
