...
class PionStopServiceBase(BasePipelineService):
    def __init__(
        self,
        *,
        ...
        if not isinstance(factory, PionStopGraphLoaderFactory):
            raise RuntimeError("Dataset is missing PionStopGraphLoaderFactory.")
        self.loader_factory = factory
        self.objective_adapter = PionStopObjectiveAdapter()
