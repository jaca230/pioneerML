...
class EndpointRegressorEvaluationService(EndpointRegressorServiceBase, BaseEvaluationService):
    step_key = "evaluate"
    ...
    def execute(self) -> dict:
        ...
        if not provider.include_targets:
            raise RuntimeError("EndpointRegressorGraphLoader must run in train mode for evaluation.")
