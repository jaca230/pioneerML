...
class EndpointRegressorInferenceModelLoaderStep(BaseModelHandleBuilderStep):
    step_key = "model_handle_builder"

    def default_config(self) -> dict:
        return {"model_subdir": "endpoint_regressor"}
...
def load_endpoint_regressor_model_step(
    ...
    return EndpointRegressorInferenceModelLoaderStep(pipeline_config=pipeline_config).execute(payloads=payloads)
