...
class EndpointRegressorGraphLoaderFactory(BaseGraphLoaderFactory):
    def __init__(
        self,
        *,
        ...
        self.group_probs_parquet_paths = (
            [str(p) for p in group_probs_parquet_paths] if group_probs_parquet_paths else None
        )
    ...
    def build_loader(self, *, loader_params: dict) -> EndpointRegressorGraphLoader:
        cfg = dict(loader_params or {})
        return EndpointRegressorGraphLoader(
