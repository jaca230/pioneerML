...
class GroupClassifierSavePredictionsService(GroupClassifierInferenceServiceBase, BaseOutputAdapterService):
        ...
        if streamed:
            ...
            if validated_files:
                ...
                for src_file, n_rows in zip(validated_files, row_counts, strict=True):
                    ...
                    table = self.build_prediction_table(event_ids_np=local_event_ids, probs_np=local_probs, num_rows=n_rows)
                ...
                table = self.build_prediction_table(event_ids_np=event_ids_np, probs_np=probs_np, num_rows=num_rows)
