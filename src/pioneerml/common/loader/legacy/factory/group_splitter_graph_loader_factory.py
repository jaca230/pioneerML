...
class GroupSplitterGraphLoaderFactory(BaseGraphLoaderFactory):
    def __init__(
        self,
        *,
    ...
    def build_loader(self, *, loader_params: dict) -> GroupSplitterGraphLoader:
        cfg = dict(loader_params or {})
        return GroupSplitterGraphLoader(
