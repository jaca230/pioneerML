...
class PositronAngleExportService(PositronAngleServiceBase, BaseExportService):
    step_key = "export"
    ...
    @staticmethod
    def _build_export_example(dataset: PositronAngleDataset):
        data = dataset.data
    ...
    def execute(self) -> dict:
        ...
        return self.export_torchscript(
            ...
            default_export_dir="trained_models/positron_angle_regression",
            default_prefix="positron_angle",
