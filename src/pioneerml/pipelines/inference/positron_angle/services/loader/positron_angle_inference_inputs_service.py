...
class PositronAngleInferenceInputsService(PositronAngleInferenceServiceBase):
    step_key = "loader"
    ...
    def execute(
        ...
        *,
        ...
        pion_stop_parquet_paths: list[str] | None,
    ) -> dict:
        ...
        if missing:
            raise ValueError(
                "Positron-angle inference requires aligned upstream prediction files. Missing: "
                + ", ".join(missing)
            )
        ...
        resolved_pion_stop_preds = self.resolve_optional_paths(pion_stop_parquet_paths)

        return {
            "input_mode": "positron_angle_graph_loader_inference_v1",
            "mode": mode,
            ...
            "use_pion_stop_preds": bool(use_pion_stop_preds),
            ...
            "pion_stop_parquet_paths": resolved_pion_stop_preds,
            ...
            "validated_pion_stop_files": list(resolved_pion_stop_preds or []),
        }
