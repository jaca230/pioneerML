...
from pioneerml.pipelines.training.endpoint_regression_event.steps.train import _collate_graphs, _split_dataset_to_graphs
...
@step
def evaluate_endpoint_regressor_event(
    module,
