"""
PyTorch Lightning DataModules for common datasets.
"""
...
from pioneerml.data import GraphGroupDataset, PionStopGraphDataset, SplitterGraphDataset


class GraphDataModule(pl.LightningDataModule):
    """Generic DataModule for graph datasets."""
