...
@LOSS_REGISTRY.register("angular_unit_vector")
@LOSS_REGISTRY.register("angular_unit_vector_loss")
class AngularUnitVectorLoss(BaseLoss):
...
@LOSS_REGISTRY.register("quantile_angular")
@LOSS_REGISTRY.register("quantile_angular_loss")
class QuantileAngularLoss(BaseLoss):
