...
class BaseMetricOutputAdapterStep(BaseOutputAdapterStep):
    """Output-adapter helpers for pluggable metric computation."""
    ...
    def resolve_metric_names(self, cfg: Mapping[str, Any] | None = None) -> list[str]:
        ...
        raise ValueError("output_adapter.metrics must be a list of metric names when provided.")
